...
export default function ImposterAIPrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-6">
        ...
        <Section title="Overview">
          <p>
            Imposter AI (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
            &ldquo;us&rdquo;) is committed to protecting your privacy. This
            Privacy Policy explains how we collect, use, disclose, and safeguard
            your information when you use our Imposter AI mobile application (the
            &ldquo;App&rdquo;) available on the Apple App Store for iPhone
            devices.
          </p>
          <p>
            Imposter AI is a social deduction game where players try to identify
            the imposter among them through word-based discussions, featuring
            AI-powered agents that can participate alongside human players.
          </p>
        </Section>
        ...
        <Section title="Information We Collect">
          <SubSection title="Local Device Information">
            <p>
              Imposter AI is designed with privacy in mind and stores most data
              locally on your device:
            </p>
            <BulletList>
              <Bullet label="Game Data:">
                Player configurations, game settings, and category preferences
                are stored locally on your device using UserDefaults
              </Bullet>
              <Bullet label="App Preferences:">
                Your selected themes, audio settings, and other app preferences
              </Bullet>
          ...
          <SubSection title="Word Database">
            <BulletList>
              <Bullet>
                A bundled word database is copied to your device and tracks
                which words have been used in gameplay. This data never leaves
                your device.
              </Bullet>
            </BulletList>
          </SubSection>
          ...
          <SubSection title="On-Device AI Processing">
            <BulletList>
              <Bullet label="Apple Foundation Models:">
                The app uses Apple&apos;s on-device language models for AI agent
              ...
              <Bullet>
                ...
                &mdash; no game data, prompts, or responses are sent to external
                servers
              </Bullet>
              <Bullet>
                <strong className="text-gray-100">
        ...
        <Section title="How We Use Your Information">
          <BulletList>
            <Bullet>
              Providing the imposter game experience with AI-powered agents
            </Bullet>
            <Bullet>
              Saving and loading your player and game configurations
            </Bullet>
        ...
        <Section title="Data Storage and Security">
          <SubSection title="Local Storage">
            <BulletList>
              <Bullet>
                All user-created content (players, categories, preferences) is
        ...
        <Section title="Third-Party Services">
          <SubSection title="Apple Services">
            ...
            <BulletList>
              ...
              <Bullet label="Apple Foundation Models:">
                For on-device AI agent processing
              </Bullet>
              <Bullet label="iOS UserDefaults:">
                For local preference storage
              </Bullet>
              <Bullet label="UserNotifications:">
                For optional local notifications (engagement reminders). No data
                is sent externally. You can disable notifications in the app
                settings or iOS Settings at any time.
              </Bullet>
            </BulletList>
          </SubSection>
          ...
          <SubSection title="External Links">
            <p>
              The app may open external Wikipedia article links in Safari when
              you tap on a word&apos;s details. These links are opened via your
              browser and are subject to Wikipedia&apos;s privacy policy. No
              data is sent from the app itself.
            </p>
          </SubSection>

          <SubSection title="Sharing">
            <p>
              Imposter AI includes a share option that shares a static App Store
              link. No personal or gameplay data is included in the shared
              content.
            </p>
          </SubSection>
          ...
          <SubSection title="No Third-Party Analytics">
            <p>
              Imposter AI does not use third-party analytics services,
              advertising networks, or data collection tools.
            </p>
          </SubSection>
        </Section>
        ...
        <Section title="Your Privacy Rights and Controls">
          ...
          <SubSection title="Notifications">
            <BulletList>
              ...
              <Bullet>
                ...
                &rarr; Imposter AI &rarr; Notifications
              </Bullet>
            </BulletList>
          </SubSection>
          ...
          <SubSection title="No Account Required">
            <BulletList>
              <Bullet>
                Imposter AI does not require account creation or personal
                information
              </Bullet>
              <Bullet>
        ...
        <Section title="Children's Privacy">
          <p>
            Imposter AI is suitable for users of all ages and does not collect
            personal information from anyone, including children under 13. The
            app operates entirely offline with local storage only.
          </p>
        </Section>
          ...
          <SubSection title="Permissions Used">
            <BulletList>
              ...
              <Bullet label="Notifications:">
                Optional local notifications for engagement reminders
              </Bullet>
              <Bullet label="StoreKit:">
                For in-app purchase processing
              </Bullet>
              <Bullet label="Apple Foundation Models:">
                For on-device AI gameplay features
              </Bullet>
            </BulletList>
          </SubSection>
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          local-first data storage and minimal data collection. Imposter AI is

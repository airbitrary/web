...
export default function Hero({
  ...
  return (
    ...
    >
      {/* Decorative blob */}
      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-white/20 blur-3xl animate-pulse-glow dark:bg-white/5" />
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center">
        ...
        <p className="mt-3 text-xl font-medium text-gray-600 dark:text-gray-300 md:text-2xl">
          {tagline}
        </p>
